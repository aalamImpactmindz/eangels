...
const PageDatenschutzClient = () => {
  ...
  return (
    <>
      <section className="section-datenschutz section-padding">
        <div className="container container-extra-small">
          ...
          <p className="text-lg font-bold">Allgemeine Hinweise</p>
          ...
          <p className="text-2xl font-bold mt-4 mb-2">Datenschutz</p>
          <p className="opacity-90">
          ...
          <p className="opacity-90">eAngels UG (Haftungsbeschränkt)</p>
          <p className="opacity-90">Kirchbergstraße 2a</p>
          <p className="opacity-90">97262 Hausen b. Würzburg</p>
          <p className="opacity-90">
            Telefon:{" "}
            <Link href="tel:097224882797" className="link-main">
              09722 488 27 97
            </Link>
          </p>
          <p className="opacity-90">
            E-Mail:{" "}
            <Link href="mailto:info@eAngels.de" className="link-main">
              info@eAngels.de
            </Link>
          </p>
          <p className="opacity-90">
          ...
          <p className="text-2xl font-bold mt-4 mb-2">Speicherdauer</p>
          <p className="opacity-90">
          ...
          <p className="text-2xl font-bold mt-4 mb-2">Cookies</p>
          <p className="opacity-90">
          ...
          <p className="text-3xl font-bold mt-8 mb-4">4. Plugins und Tools</p>
          <p className="text-2xl font-bold mt-4 mb-2">Font Awesome</p>
          <p className="opacity-90">
            Diese Seite nutzt zur einheitlichen Darstellung von Schriftarten und
            Symbolen Font Awesome. Anbieter ist die Fonticons, Inc., 6 Porter
          ...
          <p className="opacity-90 mt-2">
            ...
            diese Website aufgerufen wurde. Die Nutzung von Font Awesome erfolgt
          ...
          <p className="text-2xl font-bold mt-4 mb-2">Leadinfo:</p>
          <p className="opacity-90 mt-2 italic">
            Wir nutzen den Lead-Generation-Service von Leadinfo B.V., Rotterdam,
            Niederlande. Dieser erkennt Besuche von Unternehmen auf unserer
            Website anhand von IP-Adressen und zeigt uns hierzu öffentlich
            verfügbare Informationen, wie z.B. Firmennamen oder Adressen.
            Darüber hinaus setzt Leadinfo zwei First-Party-Cookies zur
            Auswertung des Nutzerverhaltens auf unserer Website und verarbeitet
            Domains aus Formulareingaben (z.B. „leadinfo.com“), um IP-Adressen
            mit Unternehmen zu korrelieren und die Services zu verbessern.
            Weitere Informationen finden Sie unter{" "}
            <Link
              href="https://www.eangels.de/datenschutz"
              target="_blank"
              className="text-color-primary"
            >
              www.leadinfo.com
            ...
            . Auf dieser Seite:{" "}
            <Link
              href="https://www.leadinfo.com/en/legal/opt-out/"
              className="text-color-primary"
              target="_blank"
            >
              www.leadinfo.com/en/opt-out
            </Link>{" "}
            haben Sie eine Opt-out Möglichkeit. Im Falle eines Opt-outs werden
            Ihre Daten von Leadinfo nicht mehr erfasst.
          </p>
        </div>
      </section>
    </>
...
export default PageDatenschutzClient;
